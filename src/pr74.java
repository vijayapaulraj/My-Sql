...
public class pr74 {
	...
	public pr74(){
		...
		pn2a=new JPanel();
		pn2a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn2a.add(txt3);
		...
		pn3.add(lb3);
		pn3a=new JPanel();
		pn3a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn3a.add(txt4);
		...
		pn4.add(lb4);
		pn4a=new JPanel();
		pn4a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn4a.add(txt5);
		...
		pn5.add(lb5);
		pn5a=new JPanel();
		pn5a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn5a.add(txt6);
		pn5a.add(txt7);
		pn5a.add(txt8);
		...
		pn6.add(lb6);
		pn6a=new JPanel();
		pn6a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn6a.add(txt9);
		bt=new ButtonGroup();
		bt.add(btn1);
		bt.add(btn2);
		pn6b=new JPanel();
		pn6b.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn6b.add(btn1);
		pn6b.add(btn2);
		...
		pn7=new JPanel();
		pn7.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn7.add(lb7);
		pn7a=new JPanel();
		pn7a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn7a.add(txt10);
		...
		pn8=new JPanel();
		pn8.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn8.add(lb8);
		pn8a=new JPanel();
		pn8a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn8a.add(txt11);
		...
		pn9=new JPanel();
		pn9.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn9.add(lb9);
		pn9a=new JPanel();
		pn9a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn9a.add(btn3);
		pn9a.add(lb10);
		...
		pn13=new JPanel();
		pn13.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn13.add(lb13);
		pn13a=new JPanel();
		pn13a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn13a.add(txt12);
		...
		pn10.add(lb11);
		pn10a=new JPanel();
		pn10a.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn10a.add(txt13);
		...
		pn12=new JPanel();
		pn12.setLayout(new FlowLayout(FlowLayout.CENTER));
		pn12.add(btn5);
		pn12.add(btn6);
